...
const ProductsManager = () => {
    ...
    const {title, area, price, inStock, description, content, category} = product
    ...
    const handleSubmit = async(e) => {
        ...
        if(!title || !price || !area || !inStock || !description || !content || category === 'all' || images.length === 0)
          ...
          <div className="row m-1">
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    placeholder="Address" onChange={handleChangeInput}
                    className="d-block my-4 w-100 p-2" value={content} />

                    <textarea name="area" id="area" cols="30" rows="6"
                    placeholder="Gross Area" onChange={handleChangeInput}
                    className="d-block my-4 w-100 p-2" value={area} />
